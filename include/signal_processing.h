...
struct DetectionConfirmation {
    char last_raw_detection[16];
    uint8_t tremor_consecutive;
    uint8_t dysk_consecutive;
    uint8_t none_consecutive;
    float tremor_ema_intensity;
    float dysk_ema_intensity;
};
